...
<fieldset>
<legend> Rendelés adatai&nbsp;<a onclick="javascript:document.getElementById('adatok_{$egy.rend_id}').style.display = 'none';"><img src="http://lencsek.hu/images/CloseButton.png"></a></legend>
<!--
Egészségpénztár: {$egy.penztar_nev}<br /><br />-->
