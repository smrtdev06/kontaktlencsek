<div class="product-tile col-md-3 col-sm-4 col-xs-6">
  ...
  <figure class="ws-product-bg"><img src="{$kepsrc}{$egy_termek.termek_kep}"></figure>
  <h3>{$egy_termek.termek_nev|substr:0:30}{if ($egy_termek.termek_nev|count_characters)>=29}...{/if}</h3>
  <span class="price">
