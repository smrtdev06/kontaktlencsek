                  ...
                  <div class="panel-body">
                    ...
                    <ul>
                     {foreach from=$gyartok item=egy_gyarto}
                        ...
                        <div class="gender_">
                          <div class="checkbox">
                            <a href="{$egy_gyarto.gyarto_alnev}"><input type="checkbox" value="{$egy_gyarto.gyarto_nev}" name="{$egy_gyarto.gyarto_nev}" id="{$egy_gyarto.gyarto_id}">
                  ...
                  <div class="panel-body">
                    ...
                    {foreach from=$kontaktlencsek item=egy_kat}
                      <li>
                        <div class="gender_">
                          <div class="checkbox">
                            <a href="{$egy_kat.kat_alnev}"><input type="checkbox" value="{$egy_kat.kat_alnev}" name="1.000" id="1.000">
                            <label for="1.000">{$egy_kat.kat_nev}</label></a>
                          </div>
                        </div>
                      </li>
                     {/foreach}
                      ...
                      <li>
                        <div class="gender_">
                          <div class="checkbox">
                            ...
                            <label for="Férfi">{$egy_kat.kat_nev}</label>
                          </div>
                        </div>
                      </li>
                      {/foreach}
