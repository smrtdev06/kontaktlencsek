                ...
                <div class="table-responsive mob-table mt20">
                                        <table class="table table-hover table-striped">
                                            <thead class="mob_none">
                                                <tr>
                                                    <th style="vertical-align:text-top; font-weight: normal;">Nem kérek próbát <span data-toggle="tooltip" data-html="true" title="Ha már ismeri a kiválasztott keretet..."><i class="fa fa-question-circle" aria-hidden="true"></i></span></th>
                                                    <th style="vertical-align:text-top; font-weight: normal;" colspan="3">
                                                        Ismerem a keretet, küldjék el a kész szemüveget a kiválasztott lencsével legyártva. 
                                                    </th>
                                                ...
                                                <tr>
                                                    <th style="vertical-align:text-top; font-weight: normal;">Kérek próbát <span data-toggle="tooltip" data-html="true" title="Válasszon ki bármennyi szemüvegkeretet és próbálja fel otthonában, munkahelyén vagy optikánkban mielőtt a lencsével elkészítenénk a szemüveget. Postai és futárral való szállítás esetén is csak egy kauciót kell fizetnie Ön által kiválasztott keretek árából. Amennyiben a felpróbált keretek közül valamelyik megtetszett, akkor kérjük, hogy adja meg annak cikkszámát nekünk és mi legyártjuk a megfelelő lencsével. Amely keretekre nincs szüksége, azokat a kész szemüveg átadásakor adja át a futárnak."><i class="fa fa-question-circle" aria-hidden="true"></i></span></th>
                                                    <th style="vertical-align:text-top; font-weight: normal;" colspan="3">
                                                        Szeretném felpróbálni a kiválasztott keretet.
                                                    </th>
