...
<div class="cont-block transport" style="border-color:#80776f; width:765px;">
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <form id="regisztracio" name="regisztracio" method="post" action="{$alnev.jelszo_valtoztatas}" onsubmit="return urlap1_ellenorzes(this)">
      <input type="hidden" name="kuldve" value="1">
      <input type="hidden" name="token" value="{$token}">
  
      <table width="400" class="reg-table">
      <tr>
        <td height="40" style="border-right-color:#f7f7f7;"><strong>{$ford.uj_jelszo}:</strong></td>
        <td><input name="felh_jelszo" type="password" class="textfield-specs" id="felh_jelszo" size="30" />
          *</td>
      </tr>
      <tr>
        <td height="40" style="border-right-color:#f7f7f7;"><strong>{$ford.uj_jelszo_ismetlese}: </strong></td>
