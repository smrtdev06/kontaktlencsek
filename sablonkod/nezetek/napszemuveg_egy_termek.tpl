<div class="product-one-of-all" >
    <h2><a href="{$site}{$egy_termek.termek_alnev}" class="body-link">{$egy_termek.termek_nev}</a></h2>
    <p align="left" class="product-one-of-all-man">{$egy_termek.termek_gyarto}</p>
           ...
           <a href="{$site}{$egy_termek.termek_alnev}" title="{$egy_termek.termek_nev}"><img src="http://szemuvegek.hu/termekkepek/{$egy_termek.termek_kep}" alt="{$egy_termek.termek_nev}" title="{$egy_termek.termek_nev}" border="0" /></a>
    </p>
