...
<div class="nincsproba_box" >           
    ...
    <div style="display: none; height:auto;padding:5px;" id="pickpackbox">
        <font color="#ff0000"><b>A Pick-pack rendszere túlterhelt, ha teheti válasszon másik szállítási módot!</b></font><br />
        ...
        <select class="kicsi-select" onchange="pickpack_varos_feltoltes2(this.form,this,'p_varos2')" size="1" name="p_megye2">
            <option value="0">{$ford.valassz_megyet}</option>
            {foreach from=$megyek item=megye}
                <option value="{$megye.megye_id}">{$megye.megye_nev}</option>
            {/foreach}
        ...
        <br>
        <select class="kicsi-select" onchange="hely_feltoltes2(this.form,this,'p_hely2')" size="1" name="p_varos2">
            <option value="0">{$ford.valassz_varost}</option>
        </select>
        <br>
        <select class="kicsi-select" onchange="nyitvatartas2(this)" size="1" name="p_hely2">
            <option value="0">{$ford.valassz_atveteli_pontot}</option>
        </select><br>
        <font size="-2">
        <span id="nyitvatart2">
...
<!--<a href="{$sitenev}{$alnev.kapcsolat}" target="_blank"><font color="#ff0000">Ünnepi nyitvatartás!</font></a>-->
</table>
...
-->
    ...
    <div id="extrabox" class="cont-block transport-price2" style="border-color:#80756f;display:block;">
        <table style="color:#7f766f;" width="100%">
            <tr><td align="center" bgcolor="#f4f3f1" class="prod-title" height="35" colspan="4">{$ford.extra_opciok}</td></tr>
            <tr>
                <td align="center" height="35">
                    <span style="float:left; font-size:13px; padding: 4px 0 0 15px;">{$ford.premium_futar}</span>
                    </td>
                    <td><img onmouseover="Tip('{$ford.tip_premium_futar}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="{$ford.tip_premium_futar}" alt="Mi ez pontosan?" src="view/images/kerdojel_icon_sotet.gif" height="20" />
                    </td><td>
            ...
            <tr>
                <td align="center" height="35">
                    <span style="float:left; font-size:13px; padding: 4px 0 0 15px;">{$ford.sms_ertesites}</span>
                    </td>
                    <td><img onmouseover="Tip('{$ford.tip_sms_futar}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="{$ford.tip_sms_futar}" alt="Mi ez pontosan?" src="view/images/kerdojel_icon_sotet.gif" height="20" />
                    </td>
            ...
            <tr>
                <td align="center" height="35">
                    <span style="float:left; font-size:13px; padding: 4px 0 0 15px;">{$ford.tel_ertesites}</span>
                    </td>
                    <td><img onmouseover="Tip('{$ford.tip_tel_futar}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="{$ford.tip_tel_futar}" alt="Mi ez pontosan?" src="view/images/kerdojel_icon_sotet.gif" height="20" />
                    </td>
            ...
            <tr>
                <td align="center" height="35">
                    <span style="float:left; font-size:13px; padding: 4px 0 0 15px;">{$ford.mai_bolti_atvetel}</span>
                    </td>
                    <td><img onmouseover="Tip('{$ford.tip_aznapi}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="{$ford.tip_aznapi}" alt="Mi ez pontosan?" src="view/images/kerdojel_icon_sotet.gif" height="20" />
                    </td><td>
