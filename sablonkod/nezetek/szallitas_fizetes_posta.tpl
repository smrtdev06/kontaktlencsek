...
<script src="css/dev_termekvalto.js" type="text/javascript"></script>
{/literal}
...
<div class="nincsproba_box" >           
    ...
    <div class="szallitasimod" style="line-height:20px;">
        ...
        <img onmouseover="Tip('{$ford.tip_pickpackpont}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="Ide jön majd a magyarázó szöveg!" alt="Mi ez pontosan?" src="images/kerdojel_icon_sotet.gif" height="20" /><br />
        <input id="atv3" name="atveteli" type="radio" value="posta"><label for="atv3">Postapont</label>
        <img onmouseover="Tip('Postapont')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="Ide jön majd a magyarázó szöveg!" alt="Mi ez pontosan?" src="images/kerdojel_icon_sotet.gif" height="20" />
                ...
                <span id="postaarak" style="display:none;">
                <a href="#" id="w|6|1|{$szallar_tomb[6][1].ar}" class="payment "><p>{$szallar_tomb[6][1].ar} Ft</p><span>{$ford.ingyenes_felette}</span> {$szallar_tomb[3][1].ingyen|arformat} {$ford.felett}</a>
                <a href="#" id="w|6|3|{$szallar_tomb[6][3].ar}" class="payment "><p>{$szallar_tomb[6][3].ar} Ft</p><span>{$ford.ingyenes_felette}</span> {$szallar_tomb[3][3].ingyen|arformat} {$ford.felett}</a>
                <a href="#" id="w|6|2|{$szallar_tomb[6][2].ar}" class="payment "><p>{$szallar_tomb[6][2].ar} Ft</p><span>{$ford.ingyenes_felette}</span> {$szallar_tomb[3][2].ingyen|arformat} {$ford.felett}</a>
                </span>
    ...
    <div align="left" style="display:none; height:400px;background:#ff0000;" id="postabox">
    <!-- Postapont Box -->
    <!--
    <iframe src="http://www.postapont.hu/partnermaps/terkepeskereso"
width="750" height="480" style="border:1px solid #888;"></iframe>
-->
    {literal}
    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false&language=hu&region=HU">
    </script>
...
<link rel="stylesheet" type="text/css" href="https://www.postapont.hu/static/css/postapont-api.css">
    <!-- <input type="text" id="ugyfelform_iranyitoszam"> -->
    <input type="hidden" id="valasztott_postapont" name="valasztott_postapont" value="">
...
-->
    ...
    <div id="bolti_extra" class="cont-block transport-price2" style="border-color:#80756f;">
        <table style="color:#7f766f;" width="100%">
            <tr><td align="center" bgcolor="#f4f3f1" class="prod-title" height="35" colspan="3">{$ford.extra_opciok}</td></tr>
            <tr>
                <td align="center" height="35">
                    <span style="float:left; font-size:13px; padding: 4px 0 0 15px;">{$ford.mai_bolti_atvetel}</span> <img onmouseover="Tip('{$ford.tip_aznapi}')" onmouseout="UnTip()" class="kerdojelicon_szallmod" title="{$ford.tip_aznapi}" alt="Mi ez pontosan?" src="view/images/kerdojel_icon_sotet.gif" height="20" />
                    </td><td>
                    <input id="aznapi_atvetel" type="checkbox" name="aznapi_atvetel" value="{$aznapi_osszeg}" disabled="disabled" />
                    </td><td>
                    <span style="font-size:13px; float:right; padding: 4px 16px 0 0; color:#8f6299;"><span id="futar_ar">{$aznapi_osszeg}</span> {$dev}</span>
                </td>
            </tr>
        </table>
    </div>
