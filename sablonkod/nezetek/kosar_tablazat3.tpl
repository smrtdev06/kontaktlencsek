...
<div class="cont-block pricebox" style="border-color:#80756f; float:right; width:265px;"><table style="color:#7f766f;" width="100%">
                               <tr><td align="center" bgcolor="#f4f3f1" height="35"><span style="float:left; font-size:16px; padding: 4px 0 0 15px;">{$ford.osszesen}:</span><span style="font-size:20px; float:right; padding-right:15px; color:#8f6299;"><b>{$osszesen|arformat}</b></span></td></tr>
                            </table></div>