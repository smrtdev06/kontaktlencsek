...
{foreach from=$ajandekok1 item=elem}
    <div style="float:left;text-align:center; padding:4px; height:165px;width:220px;" >
      <img src="http://kepek.lencsek.hu/images/action/{$elem.ajandek_kep}" border="0" style="max-width:220px;max-height:120px;"><br />
      <br />{$elem.ajandek_nev}<br />
      {$elem.ajandek_leiras}
      {$elem.ajandek_ertekhatar|arformat} felett
    </div>
{/foreach}
...
<br />
{foreach from=$ajandekok2 item=elem}
    <div style="float:left;text-align:center; padding:4px; height:165px;width:220px;" >
      <img src="/images/action/{$elem.ajandek_kep}" border="0" style="max-width:220px;max-height:120px;"><br />
      <br />{$elem.ajandek_nev}<br />
      {$elem.ajandek_leiras}
    </div>
{/foreach} 
