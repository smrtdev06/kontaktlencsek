...
<div style="float:left; display:block;">
  ...
  <div class="product-title">
    ...
    {if in_array($egy_termek.termek_id, array(22986,26100,20926) )}
        <!--<div style="position: relative; top:-150px;left:120px;"><img src="images/500mb.png" width="100px" border="0"></div>-->
    {/if}
	<p></p>

    {if $egy_termek.termek_kat_id >=3 and $egy_termek.termek_kat_id<=11 }
    <!--<div style="position: relative; top:-150px;left:120px;"><img src="images/AIOL-kedvezmeny.png" width="100px" border="0"></div>-->{/if}
...
<form name="urlap" method="post" action="{$filenev}" enctype="multipart/form-data" onsubmit="return urlap_ellenorzes(this);">
   ...
   <table width="100%" border="0" cellpadding="3" cellspacing="0" >
          ...
          <tr> {if $egy_termek.termek_csoport == 1}
            ...
            {if termek_jellemzo($egy_termek.termek_id,7) }
            <td bgcolor="#FFFFFF" align="center">{jellemzok jell="7" termek_id=$egy_termek.termek_id jid=2}</td>
            {/if}
...
-->
    ...
    <tr height="19">
      ...
      {if ( !in_array($egy_termek.termek_id, array(38628,19443,19441,20821,21662,38791,19476,21850,19478,42139,42138,19445,38119,46,54062,22748)) && in_array($egy_termek.termek_kat_id, array(12,13,2)) )}
      <br />
...
<div align="right">
  ...
  <div style="float:right;">
    ...
    <a href="javascript:void(0);" onmouseout="UnTip()" onmouseover="Tip('{$egy_termek.termek_szallitas_kerdojel}')"><img src="{$sitenev}images/Lencsekhu_miniBanner2.png" /></a>
