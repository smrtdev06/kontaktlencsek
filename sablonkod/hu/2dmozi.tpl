...
{/literal}
    <body leftmargin="0" marginwidth="0" topmargin="40px" marginheight="0" offset="0">
        <!--*|IF:MC_PREVIEW_TEXT|*-->
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #03557A;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                                        <strong><span style="font-size:24px">FOCUS DAILIES COMFORT PLUS (90 db) KONTAKTLENCSÉVEL&nbsp;&nbsp;</span></strong><br>
2D mozijegy ajándékba
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/bdf3e57053f00c095f464b904/images/540dd4a0-3b9f-402a-9a2f-a264a898ba0e.jpg" width="560" style="max-width:560px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: left;">2 doboz Focus Dailies Aqua Comfort Plus (90 db) kontaktlencse vásárlása esetén 1 db 2D mozijegyet adunk ajándékba.<br>
<br>
Az akció érvényesítéséhez a rendelés leadásakor a MEGJEGYZÉSbe kérjük írja be: „Mozijegy”</div>

<div style="text-align: left;"><br>
A mozijegy felhasználható:

	&nbsp;<li>a Cinema City bármelyik mozijába;
	&nbsp;<li>bármelyik 2D-s filmre;
	&nbsp;<li>bármelyik napon.
<br><br>
Az akcióban a Lencsék.hu áruházban forgalmazott Focus Dailies Aqua Comfort Plus (90 db) kontaktlencse vesz részt.<br>
&nbsp;</div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Focus Dailies Aqua Comfort Plus (90 db) kontaktlencse " href="https://lencsek.hu/Focus_Dailies_Aqua_Comfort_Plus_90_db" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Focus Dailies Aqua Comfort Plus (90 db) kontaktlencse </a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #FFFFFF;border: 1px solid #000000;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #000000;text-align: center;">
                                        <span style="font-size:12px">Az akció 2018. május 9-től érvényes 2018. június 30-ig, vagy a mozijegy készlet erejéig.<br>
<br>
A 2D-s mozijegy pénzre nem váltható.</span><br>
&nbsp;
                                    </td>
                                </tr>
                            </tbody></table>
