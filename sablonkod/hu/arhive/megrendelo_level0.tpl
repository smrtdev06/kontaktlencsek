   <table style="border-color: #4A3C31; border: solid; border: 5px; background-color: #4A3C31; " width="800">
	<tr>
		<td width="800" align="center" class="header" style="background:#4A3C31;">
	...
	<tr>
		<td class="main" align="left" style="font-family:Arial; font-size:12px;">
			...
			<table width="800" bgcolor="#fff" style="background:#fff;font-family:Arial;">
                <tr>
                    <td>
                        <h1 style="font-family:Arial; color:#404040; font-size: 17px">Kedves {$rendadat.rend_rendnev}!</h1>      
                    </td>
                </tr>   
             ...
             <table width="800" border="0" cellpadding="0" cellspacing="0" class="o-tablex" style="font-family:Arial; background-color:#FFFFFF">
             {foreach from=$tartalom item=egy}
                 <tr class="order-table-headerx" style="font-family:Arial;font-size:12px;">
                    <td align="left" valign="top" width="220" height="10" style="font-family:Arial; font-size: 16px; color: #46B7CB; font-weight: bold; background-color: #F5F5F5; padding-left:6px;">{$egy.termek_nev}</td>
                    <td align="left" valign="top" style="font-family:Arial;font-size:12px; color: #3B3B3B; background-color: #F5F5F5"><strong>{$ford.szem}</strong></td>
                    <td align="left" valign="top" style="font-family:Arial;font-size:12px; color: #3B3B3B; background-color: #F5F5F5"><strong>{$ford.szallitas}</strong></td>
					<td align="left" valign="top" style="padding-left:10px;font-family:Arial;font-size:12px; color: #3B3B3B; background-color: #F5F5F5"><strong>{$ford.mennyiseg}</strong></td>
                    <td width="100px;" align="left" valign="top" style="padding-left:10px;font-family:Arial;font-size:12px; color: #3B3B3B; background-color: #F5F5F5"><strong>{$ford.ar}</strong></td>
                 </tr>
				 ...
				 <tr class="table-arial">
                    ...
                    <td  align="left" valign="top" style=" padding-top: 5px; font-family:Arial;font-size:12px; color:#666666;"> {$ford.szemek[$egy.termek_szem]}<br />
                    ...
                    <td align="left" valign="top"  style="font-family:Arial;font-size:12px; padding-top: 5px; color:#666666;">{$ford.szallitas}: {$egy.termek_szallitas}</td>
                    <td align="left" valign="top" style=" padding-top: 5px; font-family:Arial;padding-left:10px;font-size:12px; color:#666666;">
                   {$egy.termek_db}</td>
					<td align="left" valign="top" style="font-family:Arial;padding-left:10px; padding-right:15px; font-size:12px; padding-top: 5px; color:#666666;">{$egy.termek_ar|mailnumberformat}</td>
               </tr>
    <tr>
	<td height="10px" colspan="5">&nbsp;</td>
    	...
    	<table width="800" style="background-color:#FFFFFF" cellpadding="0" cellspacing="5">
                <tr>
                    <td colspan="2">&nbsp;
                ...
                <table border="0" width="800" cellspacing="0" cellpadding="3" style="background-color:#FFFFFF">
                	...
                	<tr class="table-arial">
                        <td valign="top" width="50%" align="left">
                            <table width="100%" cellpadding="5" class="table-arial" style="background-color:#FFFFFF">
                                <tr style="font-family:Arial;font-size:12px;">
                                  <td width="50%" style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.nev}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$rendadat.rend_rendnev}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.telefon}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$rendadat.rend_telefon}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.email}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$useradat.felh_email}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.varos_telepules}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$rendadat.rend_varos}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.iranyitoszam}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$rendadat.rend_irsz}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.utca_hazszam}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$rendadat.rend_utca}</td>
                                </tr>
                                <tr>
                                  <td style="font-family:Arial;font-size:12px; color:#404040;"><b>{$ford.szallitas_es_fizetes}:</b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;">{$szallmod_ki}, {$fizmod_ki}
                       ...
                       <br /> { $smarty.session.smscurrier }
                            ...
                            <b style="font-family:Arial;font-size:12px; color: #3B3B3B;">{$ford.szamlazasi_adatok}:</b><br />
                            ...
                            <b style="color:#404040;">{$ford.egeszsegpenztar_tag}:</b> {$useradat.felh_tagnev} {/if}
                            {if !empty($useradat.felh_egazon) }<br />
                            <b style="color:#404040;">{$ford.egeszsegpenztar_azonosito}:</b> {$useradat.felh_egazon} {/if}
                            {/if}
                            </p>
					    ...
					    <td valign="top" style="font-family:Arial;font-size:12px; color: #3B3B3B;">
                            ...
                            <table width="100%" cellpadding="5" class="table-arial" style="font-family:Arial;">
                                <tr style="font-family:Arial;font-size:12px;">
                                  <td width="50%" style="font-family:Arial;font-size:12px; color: #3B3B3B;"><b>Cégnév: </b></td>
                                  <td style="font-family:Arial;font-size:12px; color:#666666;"><b> O3 Optika Kft.</b></td>
                                </tr>
								<tr style="font-family:Arial;font-size:12px;">
							...
							<p align="center" style="font-family:Arial;font-size:13px; line-height:18px">
			    ...
			    <table bgcolor="#FFFFFF"; width="800">
                    <tr>
                         <td style="background-color:#f5f4f2;font-size:18px;padding:5px;font-family:Arial; color:#404040;">
                            Felhívjuk figyelmét!        
                        </td>
                    </tr>
                    <tr>
	  ...
	  <tr>
		<td class="header" align="center" bgcolor="#4A3C31" style="background:#4A3C31;">
