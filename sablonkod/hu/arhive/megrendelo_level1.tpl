	...
	<tr>
		<td class="main" align="left" style="font-family:Arial; font-size:12px;">
			...
			<table width="800" bgcolor="#fff" style="background:#fff;font-family:Arial;">
                <tr>
                    <td>
                        <h1 style="font-family:Arial; color:#404040; font-size: 19px">Kedves {$rendadat.rend_rendnev}!</h1>      
                    </td>
                </tr>   
             ...
             {foreach from=$tartalom item=egy}
                 <tr class="order-table-headerx" style="font-family:Arial;font-size:12px;">
                    <td align="left" valign="top" width="220" height="10" style="font-family:Arial; font-size: 16px; color: #46B7CB; font-weight: bold; background-color: #F5F5F5">{$egy.termek_nev}</td>
