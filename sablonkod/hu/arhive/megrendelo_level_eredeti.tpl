...
<body>
<table width="800" style="margin:0;">
	<tr>
	...
	<tr>
		<td class="main" align="center">
   	  <div id="main">
            <div class="bev">
              <h1>Kedves {$rendadat.rend_rendnev}!</h1>
                <p>Köszönjük rendelését !
                          {if $rendadat.fiz_mod == 1} Kérjük, hogy a végösszeget ({$osszkoltseg|arformat} ) utalja át az OTP Banknál vezetett</p><p align="center" style="color:#749d1b;"><b>11703020 - 20000057 - 00000000</b></p><p> sz. számlaszámunkra. Kérjuk, hogy a rendelés számát ({$rend_id}) tüntesse fel az átutaláson. A terméket az összeg megérkezése után tudjuk küldeni.{/if} </p>
            </div>
            <div class="order-number"> {$ford.rendeles_szama}: {$rend_id}</div>
             ...
             {foreach from=$tartalom item=egy}
                 ...
                 <tr class="table-arial">
                    <td rowspan="2" align="center" valign="top"><a href="{$sitenev}{$egy.termek_alnev}" title="{$egy.termek_nev}"><img src="{$sitenev}kepek/termek_kepek/thumb_{$egy.termek_kep}" alt="{$egy_termek.termek_nev}" title="{$egy.termek_nev}" border="0" /></a></td>
                 ...
                 <tr>
                    <td colspan="2" align="right" valign="bottom"><div class="order-price">
                        <div style="float:left;">{$ford.mennyiseg}: {$egy.termek_db} </div>
            ...
            <div class="order-datas">
                	...
                	<tr class="table-arial">
                        ...
                        <td valign="top">
                            ...
                            <table width="100%" cellpadding="5" class="table-arial">
                                ...
                                <tr>
                                  <td width="50%"><b>Ügyfélszolgálat:</b></td>
                ...
                <h2 class="felhivjuk">Felhívjuk figyelmét!</h2>
                <p>
                ...
                <p align="center" style="color:#749d1b; font-size:1.6em;"><b>Köszönjük a vásárlást!</b></p>
