<?php   
    ...
    define('KEDVEZMENYKOD',"NOHAVECODE");
    ...
    include_once("includes/class.latogato.php");
    Latogato::save();
    ...
    $smarty->compile_dir  = 'includes/smarty3/compiled';
...
GROUP BY termek_gyartok.gyarto_id ORDER BY sorrend");
    ...
    //if( $adm ) {
    //    $smarty->display('fooldal_mobil.tpl');
    if( $oldal != $alnev['boltban'] ) {
        //$smarty->display('fooldal_new.tpl');
        $smarty->display('fooldal_mob.tpl');
    } else {
        $smarty->display('fooldal_boltban.tpl');
    }
