...
class verifyDomain {
    ...
    */
	...
	public function setEmailFrom($email) {
		if (!self::validate($email)) {
			...
			if ($this->exceptions) {
				throw new verifyDomainException($this->ErrorInfo);
			}
		}
		$this->from = $email;
	}
    ...
    */
    ...
    /*
		fclose($this->stream); // ez engedélyezve volt itt
 ...
 */
class verifyDomainException extends Exception {
