...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      //$v = "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      //echo "<center><h2>Please wait, your order is being processed and you";
      //echo " will be redirected to the paypal website.</h2></center>\n";
      
      $v = "<form method=\"post\" name=\"paypal_form\" ";
      $v .= "action=\"".$this->paypal_url."\" encytype=\"multipart/form-data\">\n";

      foreach ($this->fields as $name => $value) {
         $v .= "<input type=\"hidden\" name=\"$name\" value=\"".$value."\" />\n";
      }
      //$v .= "<center><br/><br/>If you are not automatically redirected to ";
      //$v .= "paypal within 5 seconds...<br/><br/>\n";
      $v .= "<input type=\"submit\" value=\"{$forditas['rendeles_kifizetese']}\">\n";
