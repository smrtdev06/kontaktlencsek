<?php
/* Smarty version 3.1.30, created on 2023-01-27 13:09:40
  from "/var/www/vhosts/kontaktlencsek.hu/httpdocs/sablonkod/hu/szallitas_es_fizetes.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_63d3cd14873d69_75819878',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2b8ff0c72e44b809ba5019311a49b3edb1e11808' => 
    array (
      0 => '/var/www/vhosts/kontaktlencsek.hu/httpdocs/sablonkod/hu/szallitas_es_fizetes.tpl',
      1 => 1674824977,
      2 => 'file',
    ),
  ),
...
function content_63d3cd14873d69_75819878 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="container">
    <div class="row">
...
<br />
<h1 align="center"><?php echo $_smarty_tpl->tpl_vars['ford']->value['szallitas'];?>
</h1><br />

        
<p align="justify">Az egyes termékek szállítási idejét azok adatlapján 
  tűntetjük fel, ezek általában termékenként különböznek.&nbsp; A szállí­tás költsége függ a fizetés és 
  a szállítás módjától, postai szállítás esetén a csomag 
  súlyától is és ingyenes bizonyos rendelési érték felett. 
  A rendszer a költséget automatikusan számí­tja és a 
  rendelési folyamat végén kijelzi. A szállítási&nbsp; 
  költségeket az oldal alján található táblázatokban 
  láthatja.<br>
  <br>
  2 féle szállítási/átvételi mód közül választhat:
</p>
<br>
<h2>Futárcéges szállítás</h2>
<br>
...
<br>
<h2>Pick-pack átvételi pontok <img SRC="kepek/pickpack.jpg"> </h2>
<p align="justify">Amennyiben nem tud megadni olyan átvételi helyet, ahol 
  hétköznap 8-17 óra között át tudják venni csomagot, úgy 
  lehetősége van az ország több mint 540 Pick-pack pontján 
  átvenni azt. 
  ...
  <br /><br>
<h1 align="center"><?php echo $_smarty_tpl->tpl_vars['ford']->value['fizetes'];?>
</h1><br />


<h2>1. Fizetés utánvéttel</h2>
<br>
<p>A csomag átvételekor készpénzben kell fizetni.</p>

<h2>2. Fizetés interneten, bankkártyával</h2>
<br>
<p> A következő tí­pusú bankkártyákkal tud fizetni interneten keresztül:  <br>
<img border="0" src="kepek/bankkartyak.jpg"><br/>
...
<tr>
<td><img src="kepek/otpay_mini.jpg" border="0" align="top"></td>
...
<br>
<h3><a id="mastercard">Mastercard Mobile</a></h3>
<br>
...
<br /><br>
-->
<h1 align="center">Egészségpénztárak</h1><br />
<p align="justify"> 
...
<table border="1" cellpadding="3" cellspacing="0" bordercolor="#C0C0C0" id="AutoNumber"   width="100%">
  ...
  <tr>
    ...
    <td align="right" valign="top">1290 Ft</td>
    <td align="right" valign="top">22 000 Ft</td>
  </tr>
  <tr>
    <td align="left" valign="top">Internetes bankkártya</td>
    <td align="right" valign="top">1290 Ft</td>
    <td align="right" valign="top">22 000 Ft</td>
  </tr>
</table>
<p align="justify"> &nbsp;
<table border="1" cellpadding="3" cellspacing="0" bordercolor="#C0C0C0" id="AutoNumber4"   width="100%">
  <tr>
  ...
  <tr>
    <td align="left" valign="top">Utánvét</td>
    <td align="right" valign="top">940 Ft</td>
    <td align="right" valign="top">18 000 Ft</td>
  </tr>
  <tr>
    <td align="left" valign="top">Internetes bankkártya</td>
    <td align="right" valign="top">940 Ft</td>
...
<br>
<p>
Termékeinkre a jogszabályban meghatározott 14 napos elállási jogot biztosítjuk. Felhívjuk figyelmét, hogy a visszavásárlási jogával csak akkor élhet, ha terméket nem használta, viselte és az sérülésmentes. A visszaküldés költségét a vásárlónak kell viselnie.
</p>
