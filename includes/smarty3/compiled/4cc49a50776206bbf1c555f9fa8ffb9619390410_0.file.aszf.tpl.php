<?php
/* Smarty version 3.1.30, created on 2018-09-24 16:15:41
  from "/var/www/vhosts/lencsek.hu/uj.lencsek.hu/sablonkod/hu/aszf.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ba8f18dda3296_19419562',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4cc49a50776206bbf1c555f9fa8ffb9619390410' => 
    array (
      0 => '/var/www/vhosts/lencsek.hu/uj.lencsek.hu/sablonkod/hu/aszf.tpl',
      1 => 1537798539,
      2 => 'file',
    ),
  ),
...
function content_5ba8f18dda3296_19419562 (Smarty_Internal_Template $_smarty_tpl) {
?>
<br />
<h1 align="center"><b>Általános szerződési feltételek</b></h1><br />
<div style="padding:34px;">
Jelen Általános szerződési feltételek (röviden: ÁSzF) tartalmazza a www.uj.lencsek.hu webáruházban (a továbbiakban: Webáruház) elérhető online termékértékesítési szolgáltatás (a továbbiakban: Szolgáltatás) igénybevevő (továbbiakban: Ön) általi használatának feltételeit.
<br><br>
...
<br><br><br />
    <h2>O3 Optika Kft. adatai</h2><br />
    <ul>
        <li>Név: O3 Optika Kft.</li>
        <li>Székhely: 1037 Budapest, Szépvölgyi út 49-61. C/5</li>
        <li>Levelezési cím: 2040 Budaörs Gyár u.2.</li>
        <li>Cégjegyzékszám: 01-09-736310</li>
        <li>Bejegyző Bíróság: Fővárosi Törvényszék Cégbírósága</li>
        <li>Adószám: 13459576-2-41</li>
        <li>Telefonszám: 06 (20) 288 4444</li>
        <li>Email cím: <a href="mailto:office@lencsek.hu">office@lencsek.hu</a></li>
    </ul>
    <br><br /><br>
    <h2>Webáruház használatának feltételei</h2><br /><br />
        <h3>Felelősség</h3><br>
            ...
            Az O3 Optika Kft. kizár minden felelősséget a Webáruház használói által tanúsított magatartásért. Ön köteles gondoskodni arról, hogy a Webáruház használata során harmadik személyek jogait vagy a jogszabályokat se közvetlenül, se közvetett módon ne sértse. Ön teljes mértékben és kizárólagosan felelős saját magatartásáért, az O3 Optika Kft. ilyen esetben teljes mértékben együttműködik az eljáró hatóságokkal a jogsértések felderítése végett.<br>
            A Felhasználók által a Webáruház használata során esetlegesen elérhetővé tett tartalmat az O3 Optika Kft. jogosult, de nem köteles ellenőrizni, és a közzétett tartalmak tekintetében az O3 Optika Kft. jogosult, de nem köteles jogellenes tevékenység folytatására utaló jeleket keresni.<br>
            A szolgáltatás oldalai olyan kapcsolódási pontokat (linkeket) tartalmazhatnak, amelyek más szolgáltatók oldalaira vezetnek.E szolgáltatók adatvédelmi gyakorlatáért és más tevékenységéért az O3 Optika Kft. nem vállal felelősséget.<br>
            ...
            Amennyiben az Ön a Webáruházon kifogásolható tartalmat észlel, köteles azt haladéktalanul jelezni az O3 Optika Kft-nek. Ha az O3 Optika Kft. jóhiszemű eljárása során a jelzést megalapozottnak találja, jogosult az információ haladéktalan törlésére vagy annak módosítására.<br>
        <br />
		<h3>Szerzői jogok</h3><br />
            ...
            Az O3 Optika Kft. fenntartja minden jogát szolgáltatásának minden elemére, különös tekintettel a www.O3 Optika Kft..hu domainnevére, az ehhez tartozó aldomainekre, az O3 Optika Kft. által foglalt minden más domainnévre, annak aloldalaira, valamint az internetes reklámfelületeire. Tilos minden olyan tevékenység, amely az O3 Optika Kft. adatbázisának kilistázására, rendszerezésére, archiválására, feltörésére (hack), forráskódjainak visszafejtésére irányul, kivéve, ha erre az O3 Optika Kft. külön engedélyt ad.<br>
            Külön megállapodás, vagy az erre a célra szolgáló szolgáltatás igénybevétele nélkül tilos az O3 Optika Kft. által rendelkezésre bocsátott felület, illetve keresőmotorok megkerülésével az O3 Optika Kft. adatbázisát módosítani, lemásolni, abban új adatokat elhelyezni, vagy meglévő adatokat felülírni.
            A Szolgáltatás igénybevételével Ön elfogadja, hogy az O3 Optika Kft. a Szolgáltatás igénybevétele során az Ön által feltöltött adatokat a vonatkozó Adatvédelmi tájékoztató keretei között bármikor és bárhol, korlátozás és külön díj fizetése nélkül felhasználhatja.<br>
    <br><br /><br>
    <h2>A Webáruházban történő vásárlás</h2><br />
        ...
        A Webáruház tartalmának jelentős része elérhető bárki számára, regisztráció nélkül és a vásárlásnak sem feltétele az érvényes regisztráció. Azonban, ha Ön regisztrálni kíván a Webáruházba, akkor a következő adatokat kell megadnia az O3 Optika Kft. részére:
            ...
            jelszó.<br>
        <br>
        A regisztráció sikeréről az O3 Optika Kft. emailben tájékoztatja Önt.<br>
        <br>
        Ön jogosult a regisztrációját bármikor törölni az <a href="office@lencsek.hu">office@lencsek.hu</a> email címre küldött üzenettel. Az üzenet megérkezését követően az O3 Optika Kft. köteles haladéktalanul gondoskodni a regisztráció törléséről. Az Ön felhasználói adatai a törlést követően azonnal eltávolításra kerülnek a rendszerből; ez azonban nem érinti a már leadott rendelésekhez kapcsolódó adatok és dokumentumok megőrzését, nem eredményezi ezen adatok törlését. Az eltávolítás után az adatok visszaállítására többé nincs mód.<br>
        <br>
        A felhasználói hozzáférési adatok (így különösen a jelszó) titokban tartásáért kizárólag Ön a felelős. Amennyiben Ön tudomást szerez arról, hogy a regisztráció során megadott jelszavához jogosulatlan harmadik személy hozzájuthatott, köteles haladéktalanul megváltoztatni jelszavát, ha pedig feltételezhető, hogy a harmadik személy a jelszó használatával bármilyen módon visszaél, köteles egyidejűleg értesíteni az O3 Optika Kft-t.<br>
        Ön vállalja, hogy a regisztráció során megadott személyes adatokat szükség szerint frissíti annak érdekében, hogy azok időszerűek, teljesek és a valóságnak megfelelőek legyenek.<br>
        <br>
		<br />
        <h2>Szerződéskötés lépései</h2>
<br />
        Ön a megrendelni kívánt termék részletes jellemzőiről, áráról, a termék nevére vagy a terméket ábrázoló képre történő kattintást követően tájékozódhat.
            Az oldalon történő vásárláshoz nem szükséges regisztráció. Regisztráció nélkül is le tudja adni az O3 Optika Kftának a rendelését.
            Keresse meg a Webáruházban azt a terméket, amit meg szeretne vásárolni, majd nyissa meg annak terméklapját.<br>
            ...
            Ha minden paramétert rendben megadott, és a mennyiséget is beállította, nyomja meg a "Megrendelem!" gombot. Ezzel a gombnyomással a termék a megadott paraméterekkel és a megadott mennyiségben az Ön virtuális kosarába fog kerülni.<br>
            ...
            Az előbbi gombnyomásra megnyíló ablakban adja meg adatait: nevét, email címét, telefonszámát, majd válasszon szállítási módot és címet, majd válasszon fizetési módot, és végül adja meg a kívánt számlázási címet. Ha elkészült, nyomja meg a "Megrendelem »" gombot, hogy véglegesíthesse vásárlását.<br>
            A megrendelés leadása a „Megrendelés” gombra kattintást követően kerül sor. A rendelés leadása az Ügyfél részére fizetési kötelezettséget keletkeztet.”<br>
            Ha elektronikus fizetést választott, akkor a Webáruház átirányítja a választott online fizetési lehetőséget biztosító O3 Optika Kft. weboldalra. Itt ki tudja fizetni a kosárba tett termékek értékét, mely kiszállítással történő rendelés esetén tartalmazza a szállítás költségét is.
            Utolsó lépésként a Webáruház felületén a megrendelés sikeres elküldését követően megjelenik a rendelési azonosítója, mely a vásárlását egyértelműen azonosítja. A rendelési azonosítót a visszaigazoló emailben is elküldjük és a visszaigazoló email (lásd bővebben 2.4. pont) tartalmazni fogja a megvásárolni kívánt termékeket, azok paramétereit, és minden más adatot is, amit a rendelés során megadott az O3 Optika Kft. részére. Ekkor Ön és az O3 Optika Kft. között szerződés jön létre, ami írásba foglaltnak minősül. Ez a szerződés kizárólag a visszaigazoló email formájában "iktatódik".
...
<br />
        ...
        <br>
        Ha Ön rendelését már elküldte az O3 Optika Kft. részére és hibát vesz észre a visszaigazoló emailben szereplő adatok tekintetében, azt 1 napon belül jeleznie kell az O3 Optika Kft. felé, a nem kívánt rendelések teljesítésének elkerülése érdekében.<br>
        <br>
        Ön mentesül az ajánlati kötöttség alól, ha késedelem nélkül (48 órán belül) nem kapja meg az O3 Optika Kft.tól az elküldött rendelésére vonatkozó visszaigazoló emailt.<br>
        <br>
        E visszaigazoló email az O3 Optika Kft. részéről az Ön által tett ajánlat elfogadásának minősül, mellyel érvényes szerződés jön létre az O3 Optika Kft. és Ön között.<br>
        <br>
        ...
        <br><br><br />
        <h2>Termékek vételára</h2>
<br />
        A termékek vételára a Webáruházban az általános forgalmi adót és egyéb közterheket is tartalmazó módon van feltüntetve. A termékek vételára nem tartalmazza a kiszállítás költségét. A kiszállítás költségeiről az ÁSzF 3.8 pontjában tájékozódhat.<br>
        <br>
...
<br />
        ...
        <br><br><br />
        <h2>Kiszállítási határidő</h2>
<br />
            A szállítási határidőről a termék adatlapján találhat pontos információt. Amennyiben egy rendeléshez Ön több terméket is választ, minden esetben a kiválasztott termékek adatlapján szereplő leghosszabb szállítási határidő a mérvadó. A Webáruházban meghirdetett szállítási határidők nem garantáltak, csak tájékoztató jellegűek. Amennyiben nem tudjuk ehhez tartani magunkat önhibánkon kívül, úgy a szállítási határidő eltolódhat., melyről minden esetben értesítjük Önt emailben. A megrendelésnél kérjük vegyék figyelembe az esetleges hosszabb határidőket, amennyiben rendelésük sürgőssége indokolja, kérjük a szállítás egyeztetése céljából keresse fel ügyfélszolgálati munkatársunkat a megadott telefonszámon.<br>
            A termékek kiszállítási általános határideje 5-20 munkanap.
            <br><br /><br />
            <h3>Kiszállítás módja</h3>
<br />
            A megrendelések kiszállítása, kézbesítése munkanapokon 8.00 és 16.00 óra között - előzetes egyeztetés nélkül – történik az alább felsorolt futárszolgálatok valamelyikével, amelyiket Ön a megrendelés leadása során megjelöli:<br>
                <br><br />
                <h2>Futár (Sprinter Futárszolgálat Kft.)</h2>
<br />
                Szállítási címnek minden esetben olyan címet adjon meg (pl.: munkahelyi cím), ahol munkanapokon 8.00 és 17.00 óra között folyamatosan tartózkodik és a rendelt terméke(i)t át tudja venni. Az O3 Optika Kft. küld Önnek a kiszállítás előtti munkanapon emailben értesítést a futáros feladás tényéről és a fuvarlevélszámról. A kiszállítás reggelén Ön egy SMS-t fog kapni a futártól, hogy hozzávetőlegesen mikor érkezik a csomagja. Szükség esetén Ön tud kapcsolatba lépni a futárcéggel és pontosítani a kiszállítási adatokon. A futárszolgálat elérhetősége: 06 (1) 347 3000, weben: <a href="www.sprinter.hu">www.sprinter.hu</a>, emailen: <a href="mailto:info@sprinter.hu">info@sprinter.hu</a>.
<br><br>
...
<br><br>
                Átvételi címnek minden esetben olyan címet válasszon a szolgáltató listájából, ahol 5 munkanapokon belül a rendelt terméke(i)t át tudja venni a csomagponton vagy csomagautomatából. Az O3 Optika Kft. küld Önnek a kiszállítás előtti munkanapon emailben értesítést a futáros feladás tényéről és a fuvarlevélszámról. A kiszállítás reggelén Ön egy SMS-t fog kapni a futártól, hogy hozzávetőlegesen mikor érkezik a csomagja. Szükség esetén Ön tud kapcsolatba lépni a futárcéggel és pontosítani a kiszállítási adatokon. A futárszolgálat elérhetősége: 06 (1) 767 82 72, weben: <a href="www.postapont.hu">www.postapont.hu</a>, emailen: <a href="mailto:uzleti.ugyfelszolgalat@posta.hu">uzleti.ugyfelszolgalat@posta.hu</a>.
<br><br>
                A futár 5 napig őrzi csomagját a kiválasztott átvételi ponton, és az átvétel elmaradása esetén a 4. napon visszaszállítja azt O3 Optika Kftának. Amennyiben az átvétel - Önnek felróható okból - hiúsult meg, akkor O3 Optika Kft. törli a megrendelését. Ha azonban a későbbiekben mégis szeretné a törölt rendelésben foglaltak kiszállítását, akkor azokat újra meg kell rendelnie a Webáruházban.
                Külföldre ajánlott küldeményként (Post2Me.hu Szolgáltató Kft.)
<br><br>
                Szállítási címnek minden esetben olyan címet adjon meg (pl.: munkahelyi cím), ahol munkanapokon 8.00 és 17.00 óra között folyamatosan tartózkodik és a rendelt terméke(i)t át tudja venni. Az O3 Optika Kft. emailben küld Önnek értesítést az ajánlott küldemény feladásának tényéről és a küldemény sorszámáról. Szükség esetén Ön tud kapcsolatba lépni O3 Optika Kftával és pontosítani a kiszállítási adatokon. O3 Optika Kft. elérhetősége: 06 (30) 22 22 275, weben: www.O3 Optika Kft..hu, emailen: <a href="mailto:office@lencsek.hu">office@lencsek.hu</a>.
<br><br>
...
<br><br>
            <h3>Személyes átvétel az O3 Optika Kft. budapesti üzleteiben</h3>
<br />
            Ön megrendelését ingyenesen személyesen átveheti 4 optikánkban:<br>
            1088 Budapest, József körút 11. (Blahánál)<br> 
            Nyitva tartás:<br>
            H:10-18h K-Cs:10-19h P:10-18h Szo: 10-18h<br><br>
            
            1114 Budapest, Bartók Béla út 64. (Móricz Zsigmond körtér)<br>
            Nyitva tartás:<br>
            H-P:10-18h Szo: 09-13h<br><br>
            
            1095 Budapest, Soroksári út 16/D. (Boráros térnél)<br>
            H-P:10-18h<br><br>
            
            1065 Budapest, Bajcsy-Zsilinszky út 55. (Nyugatinál)<br>
            Nyitva tartás:<br>
            H:10-18h K-Cs:10-19h P:10-18h<br><br>
            

            Fontos, hogy várja meg a visszaigazoló emailünket arról, hogy "rendelése személyesen átvehető". (Ha sürgős volt rendelése és a rendelés során látta, hogy raktárról tudjuk teljesíteni, akkor jelezze nekünk sürgősségi igényét emailben, hogy még aznap át tudja venni termékeit.)
            Az O3 Optika Kft. iroda elérhetősége: 06 20 288 4444 vagy <a href="mailto:office@lencsek.hu">office@lencsek.hu</a>.
<br /><br /><br />
            <h3>Pick Pack Ponton történő átvétel</h3>
<br />
            ...
            Térképen <a href="https://online.sprinter.hu/terkep/#/">itt</a> tudja megtekinteni az Önhöz közeli Pick Pack Pontokat, és azok nyitva tartási rendjét.
<br /><br /><br />
            <h3>PostaPonton történő átvétel</h3>
<br />
...
<br /><br /><br />
            <h3>FoxPost csomagautomatából történő átvétel</h3>
<br />
            Országszerte a több mint 80 FoxPost csomagautomata egyikéből át tudja venni a megrendelését.<br>
    <br><br />
    <h2>Elállási jog</h2>
<br />
...
<br><br>
    Fogyasztó a szerződés megkötésének a napja és a termék átvételének napja közötti időszakban is gyakorolja elállási jogát.
        Fogyasztót a következő esetekben nem illeti meg az elállási jog:
            olyan termék vagy szolgáltatás tekintetében, amelynek ára, illetve díja a pénzpiac O3 Optika Kft. által nem befolyásolható, a 14 napos elállási határidő alatt is lehetséges ingadozásától függ;
            olyan nem előre gyártott termék esetében, amelyet a Fogyasztó utasítása alapján vagy kifejezett kérésére állított elő az O3 Optika Kft., vagy olyan termék esetében, amelyet egyértelműen a Felhasználó személyére szabtak;
...
<br><br><br />
  <h2>Elállási jog gyakorlásának a menete</h2><br />
        Ha a Fogyasztó elállási jogával élni kíván, elállási szándékát tartalmazó egyértelmű nyilatkozatát köteles eljuttatni (például postán, telefaxon vagy elektronikus úton küldött levél útján) a jelen ÁSzF 1. pontjában feltüntetett elérhetőségek igénybevételével az O3 Optika Kft. részére. Ebből a célból Fogyasztó felhasználhatja a megrendelést visszaigazoló emailhez mellékelt elállásinyilatkozat-mintát is, ami letölthető <a href="/files/elallasi_felmondasi_nyilatkozat_lencsek_hu.doc">innen</a>. Fogyasztó határidőben gyakorolja elállási jogát, ha a fent megjelölt határidő lejárta előtt elküldi elállási nyilatkozatát az O3 Optika Kft. részére.
<br><br>
...
<br><br>
            Ön a választott kellékszavatossági jogáról egy másikra is áttérhet, az áttérés költségét azonban köteles viselni, kivéve, ha az indokolt volt, vagy arra az O3 Optika Kft. adott okot.
            Ön köteles a hibát annak felfedezése után haladéktalanul, de nem később, mint a hiba felfedezésétől számított kettő hónapon belül közölni az O3 Optika Kftával.<br>
...
<br><br>
            ...
            Ön termékszavatossági igényét az ingó dolog gyártójával vagy forgalmazójával (O3 Optika Kft.) szemben gyakorolhatja.
<br><br>
            A gyártó, forgalmazó (O3 Optika Kft.) kizárólag akkor mentesül termékszavatossági kötelezettsége alól, ha bizonyítani tudja, hogy:
...
<br><br>
            Név: O3 Optika Kft.<br>
            Levelezési cím: 2040 Budaörs Gyár utca 2.<br>
            Telefon: 06 20 288 4444<br>
            Email: <a href="mailto:office@lencsek.hu">office@lencsek.hu</a>
			<br /><br />
        <h3>Panaszügyintézés módja</h3>
<br />
...
<br />
        ...
        <br /><br />
		<h3>Egyéb jogérvényesítési lehetőségek</h3>
<br />
            Amennyiben az O3 Optika Kft. és Ön között esetlegesen fennálló jogvita az O3 Optika Kft.val való tárgyalások során nem rendeződik, bírósági eljárást kezdeményezhet, továbbá fogyasztói jogvita esetén az alábbi jogérvényesítési lehetőségek állnak nyitva Ön számára:
                Panasztétel a fogyasztóvédelmi hatóságnál (2017.jan.01-től a helyi Területileg illetékes járási hivatalokhoz hatásköre <a href="http://jarasinfo.gov.hu">http://jarasinfo.gov.hu/</a><br>
...
<br><br>
            ...
            Fax: 06 (1) 488 21 86
            Email: <a href="mailto:bekelteto.testulet@bkik.hu">bekelteto.testulet@bkik.hu</a>
<br><br>
            Az egyéb békéltető testületek elérhetőségei és további tájékoztatás megtalálható az alábbi linken: <a href="http://www.bekeltetes.hu/index.php?id=testuletek">Békéltető testületek elérhetőségei</a>
<br><br>
...
<br><br>
            Az Európai Bizottság által fejlesztett és üzemeltetett online vitarendezési platform (ODR), amely jogviták rendezésére használható, elérhető az alábbi linken: <a href="http://ec.europa.eu/odr" target="_blank">http://ec.europa.eu/odr</a>, a platform használatának feltételeivel együtt.
    <br /><br /><br />
	<h1 align="center">Általános szerződési feltételek egyoldalú módosítása</h1>
<br />
...
<br />
    ...
    <br /><br /><br />
	<h1>Egyéb rendelkezések</h1>
<br />
        Az O3 Optika Kft. fenntartja a jogot, hogy bármikor, bármilyen változtatást, javítást hajtson végre a Webáruházon, előzetes figyelmeztetés nélkül és hogy a Webáruházat más domainnév alá helyezze át.<br>
        Általános szerződési feltételek ezen verziója 2017.01.01-től érvényes.
		<br /><br />
</div><?php }
}
