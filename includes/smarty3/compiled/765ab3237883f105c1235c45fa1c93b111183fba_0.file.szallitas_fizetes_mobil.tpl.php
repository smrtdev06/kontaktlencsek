<?php
/* Smarty version 3.1.30, created on 2018-10-10 15:35:50
  from "/var/www/vhosts/lencsek.hu/uj.lencsek.hu/sablonkod/szallitas_oldal/szallitas_fizetes_mobil.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bbe00365a8972_84581162',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '765ab3237883f105c1235c45fa1c93b111183fba' => 
    array (
      0 => '/var/www/vhosts/lencsek.hu/uj.lencsek.hu/sablonkod/szallitas_oldal/szallitas_fizetes_mobil.tpl',
      1 => 1539178512,
      2 => 'file',
    ),
  ),
...
function content_5bbe00365a8972_84581162 (Smarty_Internal_Template $_smarty_tpl) {
                    ...
                    <thead class="mob_none">
                        <tr>
                            ...
                            <th style="vertical-align:text-top">
                                <h3 class="blue "><?php echo $_smarty_tpl->tpl_vars['ford']->value['eloreutalas'];?>
 <a data-toggle="tooltip" data-html="true" style="color:#424242" title="<?php echo $_smarty_tpl->tpl_vars['ford']->value['tip_elore_utalas'];?>
...
<tr><td>
    ...
    <select name="p_megye" size="1" onchange="hely_feltoltes(this.form,this,'p_varos')" class="form-control">
...
"><i class="fa fa-question-circle" aria-hidden="true"></i></span></h4>
    ...
    <td id="w|3|1|<?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[3][1]['ar'];?>
" class="oh_hover payment ">
    <h3 class="blue mob-ver"><?php echo $_smarty_tpl->tpl_vars['ford']->value['eloreutalas'];?>
</h3>
        <div class="blue">
            <h2> <span><?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[3][1]['ar'];?>
 Ft</span></h2>
            <h4> <span><?php echo $_smarty_tpl->tpl_vars['ford']->value['ingyenes_felette'];?>
...
"><i class="fa fa-question-circle" aria-hidden="true"></i></span></h4>
    ...
    <td id="w|2|1|<?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[2][1]['ar'];?>
" class="oh_hover payment ">
    <h3 class="blue mob-ver">Előre utalás</h3>
        <div class="blue">
            <h2> <span><?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[2][1]['ar'];?>
 Ft</span></h2>
            <h4> <span><?php echo $_smarty_tpl->tpl_vars['ford']->value['ingyenes_felette'];?>
...
<tr>
    <td>
        <div class="lens-sel">
            ...
            <h4> <?php echo $_smarty_tpl->tpl_vars['ford']->value['szemelyesen'];?>
 <span data-toggle="tooltip" data-html="true" title="Partnerünk boltjában, a Blahánál 1088 Bp. József Krt. 11. vagy a Nyugatinál 1065 Bp. Bajcsy-Zsilinszky 55. szám alatt található optikában. Szállítási idő: 0-1 munkanap (raktáron lévő termékek esetében). A nem fizetett terméket maximum 2 munkanapig tudjuk félretenni!"><i class="fa fa-question-circle" aria-hidden="true"></i></span> </h4>
            
        </div>
    </td>
    <td id="w|4|1|<?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][1]['ar'];?>
" class="oh_hover payment ">
    <h3 class="blue mob-ver">Előre utalás </h3>
        <div class="blue">
            <h2> <span><?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][1]['ar'];?>
 Ft</span></h2>
            <h4> <span><?php echo $_smarty_tpl->tpl_vars['ford']->value['ingyenes'];?>
</span></h4>
        </div>
    </td>
    <td id="w|4|3|<?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][3]['ar'];?>
" class="oh_hover_green payment ">
    <h3 class="green mob-ver">Utánvét/Készpénz</h3>
        <div class="green">
            <h2><span><?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][3]['ar'];?>
 Ft</span></h2>
            <h4> <span><?php echo $_smarty_tpl->tpl_vars['ford']->value['ingyenes'];?>
</span></h4>
        </div>
    </td>
    <td id="w|4|2|<?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][2]['ar'];?>
" class="oh_hover payment "> <!-- oh_hover_active -->
    <h3 class="blue mob-ver">Bankkártyás fizetés</h3>
        <div class="blue">
            <h2> <span><?php echo $_smarty_tpl->tpl_vars['szallar_tomb']->value[4][2]['ar'];?>
 Ft</span></h2>
            <h4> <span><?php echo $_smarty_tpl->tpl_vars['ford']->value['ingyenes'];?>
</span></h4>
        </div>
                    ...
                    <table class="table border table-hover table-striped mt20">
                        ...
                        <tr id="gls_sor">
                             <td><p>  GLS futár
                                ...
                                <td>
                                    <div class="checkbox">  <label><input type="checkbox" name="premium_futar" value="">200 Ft</label></div>
                                </td>
                        </tr>
                            ...
                            <tr id="sms_sor">
                                ...
                                <td>
                                    <div class="checkbox">  <label><input name="sms_ertesites" type="checkbox" value="">80 Ft</label></div>
                                </td>
                            ...
                            <tr id="tel_sor">
                                ...
                                <td>
                                    <div class="checkbox">  <label><input name="tel_ertesites" type="checkbox" value="">80 Ft</label></div>
                                </td>
                            </tr>
